...
class RoommateControllerSemesterTest {
    ...
    @Test
    @DisplayName("200 반환 — 목록 조회 시 전체 게시글 반환")
    void should_return_all_boards() throws Exception {
        // given
        ...
        given(roommateService.getRoommateBoardList(any(), any())).willReturn(List.of(r1, r2));
