...
public interface TipApiSpecification {
    ...
    @Operation(
            summary = "팁 게시글 등록",
            description = "토큰, 팁 등록정보, 이미지 파일을 통해 팁 게시글 등록을 진행합니다.",
            responses = {
    ...
    public ResponseEntity<Void> saveTip(
            ...
            @RequestPart("images")
            @Parameter(description = "팁 게시글 이미지 파일 목록", required = true) List<MultipartFile> images);
    ...
    @Operation(
            summary = "팁 게시글 수정",
            description = "작성자만 자신의 팁 게시글을 수정할 수 있습니다.",
            responses = {
    ...
    public ResponseEntity<Void> updateTip(
            ...
            @RequestPart
            @Parameter(description = "수정할 이미지 파일 목록", required = true) List<MultipartFile> images,
            @PathVariable
            @Parameter(description = "팁 게시글 ID", required = true, example = "1") Long tipId);
