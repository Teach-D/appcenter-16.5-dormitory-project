...
public interface CalenderRepository extends JpaRepository<Calender,Long> {
    ...
    @Modifying
    @Query("DELETE FROM Calender c WHERE c.sourceAnnouncementId = :id AND c.aiGenerated = true")
    void deleteAiGeneratedBySourceId(@Param("id") Long sourceAnnouncementId);
}