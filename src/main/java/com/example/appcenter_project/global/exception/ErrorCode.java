...
public enum ErrorCode {
    ...
    USER_GROUP_ORDER_KEYWORD_ALREADY_EXISTS(NOT_ACCEPTABLE, 15002, "[UserGroupOrderKeyword] 해당 유저공동구매 키워드가 이미 존재합니다"),
    USER_GROUP_ORDER_CATEGORY_ALREADY_EXISTS(FORBIDDEN, 15003, "[UserGroupOrderKeyword] 해당 유저공동구매 카테고리가 이미 존재합니다"),
