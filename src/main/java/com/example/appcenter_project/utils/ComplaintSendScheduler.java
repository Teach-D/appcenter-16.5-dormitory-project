    ...
    public void executeEveryWeekdayAt10AM() {
        ...
        for (Object value : values) {
            if (value instanceof Number) {
                ...
                UserNotification userNotification = userNotificationRepository.findById(userNotificationId).orElseThrow(() -> new CustomException(ErrorCode.USER_NOTIFICATION_NOT_FOUND));
                User receiveUser = userNotification.getUser();
                Notification notification = userNotification.getNotification();
                log.info(" send userNotificationId: {}, receiveUser: {}, notification: {}", userNotificationId, receiveUser, notification);
